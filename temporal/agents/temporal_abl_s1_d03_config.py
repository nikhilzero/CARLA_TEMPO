...
class GlobalConfig:
    """Configuration for ablation stride=1 d03 (dropout=0.3) closed-loop evaluation."""
    ...
    model_path = "/scratch/nd967/CARLA_TEMPO/runs/ablations/20260406-123444-ablation_T4_stride1_research_d03-T4/checkpoint-15.pth.tar"
    temporal_frames = 4; frame_stride = 1; temporal_depth = 2
