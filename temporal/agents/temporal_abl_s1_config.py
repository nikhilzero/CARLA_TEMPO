...
class GlobalConfig:
    """Configuration for ablation stride=1 d01 (dropout=0.1) closed-loop evaluation."""
    ...
    model_path = "/scratch/nd967/CARLA_TEMPO/runs/ablations/20260406-121120-ablation_T4_stride1_research-T4/checkpoint-10.pth.tar"
